...
var useKeyBoard = (props2, context) => {
...
var useHistory = (props2, textAreaRef) => {
  var _a, _b;
  const previewOnly = inject("previewOnly");
...
var useMarked = (props2, mermaidData) => {
...
var useAutoScroll = (props2, html, textAreaRef, previewRef, htmlRef) => {
  const previewOnly = inject("previewOnly");
  const ult = inject("usedLanguageText");
  const editorId = inject("editorId");
  let clearScrollAuto = () => {
  ...
  const initCopyEntry = () => {
    document.querySelectorAll(`#${editorId} .${prefix}-preview pre`).forEach((pre) => {
      ...
      copyButton.innerText = ((_a = ult.value.copyCode) == null ? void 0 : _a.text) || "\u590D\u5236\u4EE3\u7801";
      copyButton.addEventListener("click", () => {
        var _a2;
        copyToClipboard(pre.querySelector("code").innerText);
        copyButton.innerText = ((_a2 = ult.value.copyCode) == null ? void 0 : _a2.tips) || "\u5DF2\u590D\u5236\uFF01";
        setTimeout(() => {
          var _a3;
          copyButton.innerText = ((_a3 = ult.value.copyCode) == null ? void 0 : _a3.text) || "\u590D\u5236\u4EE3\u7801";
        }, 1500);
      });
...
var useAutoGenrator = (props2, textAreaRef) => {
  const previewOnly = inject("previewOnly");
